...
/**
 * Configuration file for WiFi network settings
 * Update these values according to your university's WiFi configuration
 */
public class WifiConfig {
    ...
    /**
     * Check if we should trust the current WiFi connection
     * This is useful when SSID is unknown but we're in a controlled environment
     */
