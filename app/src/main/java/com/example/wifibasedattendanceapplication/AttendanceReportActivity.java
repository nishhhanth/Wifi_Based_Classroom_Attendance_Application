 ...
 * - Shows present/absent/total counts for a given sessionId
 * - Exports an .xlsx to Downloads using MediaStore (no legacy storage perms needed)
 *
 * Intent extra required: "sessionId"
 */
